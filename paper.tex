...
Imagine yourself in the shoes of a student who has just graduated college with an undergraduate degree in statistics, and started their first job working with data.
The new manager gives them a challenge: ``Here are your login credentials for our cloud provider services. Here's 1 TB of data stored in XML that nobody has yet had time to look at. Familiarize yourself with it and find us some insights.''
This is certainly a tall order, but the graduate who has the skills to even \emph{begin} such a task is valuable and rare indeed.

Big Data: large, unwieldy  

%Could a recetngraduate from your program even begin this task?


\subsection{The class: Stat 129}
