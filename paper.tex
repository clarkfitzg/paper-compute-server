...
Stat 129, `Analyzing and Processing Big Data', is an upper division elective course offered by the Mathematics and Statistics Department at California State University, Sacramento, and is required for students pursuing a bachelor's degree in statistics with an emphasis in data science.
...
Stat 129 requires a programming prerequisite, and the most successful students have been very comfortable with programming.
...
\begin{enumerate}
\item \textbf{Size:} The files should be large enough to motivate the computational techniques we are learning, but no larger, as described above.
