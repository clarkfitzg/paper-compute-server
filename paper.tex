...
\author{Clark Fitzgerald \protect\\
...
Section~\ref{sec:stat129} describes the class, including what kind of data suits our pedagogical purpose (Section~\ref{sec:data}) and why we need a compute server (Section~\ref{sec:server}).
